...
> **本项目：** 单 HTML 串口调试工具
> **当前版本：** v1.3.21（卡片系统基础 1×1/2×1 尺寸体系 + 5 新 type 颜色变量 + TREND 2×1 变体，2026-08-18）
> **最近更新：** 2026-08-18(v1.3.21 同步 PROJECT-HANDOVER 当前版本)
...
- **当前版本：** v1.3.21（卡片系统基础 1×1/2×1 尺寸体系 + 5 新 type 颜色变量 + TREND 2×1 变体）
