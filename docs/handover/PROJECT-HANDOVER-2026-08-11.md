...
> **本项目：** 单 HTML 串口调试工具
> **当前版本：** v1.3.12（卡片右上 type 缩写 + 右下 direction + control 状态突出，2026-08-17）
> **最近更新：** 2026-08-17(v1.3.12 同步 PROJECT-HANDOVER 当前版本)
...
- **当前版本：** v1.3.12（卡片右上 type 缩写 + 右下 direction + control 状态突出）
